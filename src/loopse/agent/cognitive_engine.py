...
本文件提供所有 Agent 共享的认知引擎原语，包括推理步骤 (ReasoningStep)、
Agent 运行轨迹 (AgentTrace)、计划-执行-自反 (CognitiveAgentMixin) 以及
兼容旧异步测试的 AwaitableDict。它不是独立的 Agent，而是被 Orchestrator、
Diagnosis、Profiler、ResourceGenerator、PathPlanner 等 Agent 继承或调用的
基础能力层。
"""
